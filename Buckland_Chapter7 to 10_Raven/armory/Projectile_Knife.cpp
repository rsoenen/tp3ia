...
//-------------------------- ctor ---------------------------------------------
//-----------------------------------------------------------------------------
KnifeHit::KnifeHit(Raven_Bot* shooter, Vector2D target):
        ...
        Raven_Projectile(target,
                         ...
                         shooter->Pos(),
                         shooter->Facing(),
                         script->GetInt("Knife_Damage"),
                         script->GetDouble("Knife_Scale"),
                         script->GetDouble("Knife_MaxSpeed"),
                         script->GetDouble("Knife_Mass"),
                         script->GetDouble("Knife_MaxForce"))
{
