...
void RocketLauncher::InitializeFuzzyModule()
{
  ...
  m_FuzzyModule.AddRule(FzAND(Target_Contact, Ammo_Loads), FzVery(Undesirable));
  m_FuzzyModule.AddRule(FzAND(Target_Contact, Ammo_Okay), FzVery(Undesirable));
  ...
  m_FuzzyModule.AddRule(FzAND(Target_Medium, Ammo_Loads), FzVery(VeryDesirable));
  m_FuzzyModule.AddRule(FzAND(Target_Medium, Ammo_Okay), VeryDesirable);
  m_FuzzyModule.AddRule(FzAND(Target_Medium, Ammo_Low), FzFairly(VeryDesirable));
  ...
  m_FuzzyModule.AddRule(FzAND(Target_Far, Ammo_Okay), FzFairly(Desirable));
  m_FuzzyModule.AddRule(FzAND(Target_Far, Ammo_Low), FzFairly(Desirable));
